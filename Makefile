# This Makefile is for the Apache::PerlVINC extension to perl.
#
...
#	INC => q[-I/usr/lib/perl5/site_perl/5.005/i386-linux/auto/Apache/include -I/usr/lib/perl5/site_perl/5.005/i386-linux/auto/Apache/include/modules/perl -I/usr/lib/perl5/site_perl/5.005/i386-linux/auto/Apache/include/include -I/usr/lib/perl5/site_perl/5.005/i386-linux/auto/Apache/include/regex -I/usr/lib/perl5/site_perl/5.005/i386-linux/auto/Apache/include/os/unix -I/usr/local/apache/include]
#	NAME => q[Apache::PerlVINC]
#	VERSION_FROM => q[PerlVINC.pm]
...
AR_STATIC_ARGS = cr
NAME = Apache::PerlVINC
DISTNAME = Apache-PerlVINC
NAME_SYM = Apache_PerlVINC
VERSION = 0.02
VERSION_SYM = 0_02
XS_VERSION = 0.02
INST_BIN = blib/bin
...
FULLEXT = Apache/PerlVINC
BASEEXT = PerlVINC
PARENT_NAME = Apache
DLBASE = $(BASEEXT)
VERSION_FROM = PerlVINC.pm
INC = -I/usr/lib/perl5/site_perl/5.005/i386-linux/auto/Apache/include -I/usr/lib/perl5/site_perl/5.005/i386-linux/auto/Apache/include/modules/perl -I/usr/lib/perl5/site_perl/5.005/i386-linux/auto/Apache/include/include -I/usr/lib/perl5/site_perl/5.005/i386-linux/auto/Apache/include/regex -I/usr/lib/perl5/site_perl/5.005/i386-linux/auto/Apache/include/os/unix -I/usr/local/apache/include
OBJECT = $(BASEEXT)$(OBJ_EXT)
LDFROM = $(OBJECT)
LINKTYPE = dynamic

# Handy lists of source code files:
XS_FILES= PerlVINC.xs
C_FILES = PerlVINC.c
O_FILES = PerlVINC.o
H_FILES = 
MAN1PODS = 
MAN3PODS = PerlVINC.pm
...
TO_INST_PM = PerlVINC.pm

PM_TO_BLIB = PerlVINC.pm \
	$(INST_LIBDIR)/PerlVINC.pm
...
# Apache::PerlVINC might depend on some other libraries:
...
manifypods : pure_all PerlVINC.pm
	@$(POD2MAN) \
	PerlVINC.pm \
	$(INST_MAN3DIR)/Apache::PerlVINC.$(MAN3EXT)
...
clean ::
	-rm -rf PerlVINC.c ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all perlmain.c mon.out core so_locations pm_to_blib *~ */*~ */*/*~ *$(OBJ_EXT) *$(LIB_EXT) perl.exe $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def $(BASEEXT).exp
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Apache-PerlVINC\" VERSION=\"0,02,0,0\">\n}. qq{\t<TITLE>Apache-PerlVINC</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Apache-PerlVINC.ppd
